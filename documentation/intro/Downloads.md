...
- Windows - [AISandbox-Server-2.0.0-win-install.exe](https://files.aisandbox.dev/AISandbox-Server-2.0.0-win-install.exe)
- Linux - [AISandbox-Server-2.0.0-linux-install.sh](https://files.aisandbox.dev/AISandbox-Server-2.0.0-linux-install.sh)
...
- Windows - [AISandbox-Server-2.0.0-win.zip](https://files.aisandbox.dev/AISandbox-Server-2.0.0-win.zip)
- Linux - [AISandbox-Server-2.0.0-linux.tar](https://files.aisandbox.dev/AISandbox-Server-2.0.0-linux.tar)
- Mac - [AISandbox-Server-2.0.0-mac.tar](https://files.aisandbox.dev/AISandbox-Server-2.0.0-mac.tar)

# Compiling from source

The full source code, which you can examine and compile yourself.

- Release [2.0.0](https://github.com/graham-evans/AISandbox-Server/releases/tag/2.0.0)
