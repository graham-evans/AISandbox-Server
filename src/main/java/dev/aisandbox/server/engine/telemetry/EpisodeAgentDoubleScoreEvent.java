...
/**
 * Telemetry event to denote a simulation episode completing with a double precision score per agent.
 *
...
public record EpisodeAgentDoubleScoreEvent(String simulationName,
    ...
    public List<String> toJSON() {
        return agentScoreList.stream()
                .map(a -> String.format(jsonTemplate, episodeFinishedTime.toString(), simulationName, sessionID, episodeID, a.agentName(), a.score()))
                .toList();
    }
