 ...
 *
 * <p>This interface defines the contract for axis scaling implementations that convert raw data
 * values into appropriate display coordinates and formatted labels. Different implementations can
 * provide various scaling strategies such as linear, logarithmic, or "nice number" scaling that
 * produces human-friendly axis labels.
 *
...
public interface AxisScale {
   ...
   *
   * <p>This value represents the lower bound of the axis range and is used for positioning the
   * axis origin and scaling data points.
   *
   ...
   *
   * <p>This value represents the upper bound of the axis range and is used for positioning the
   * axis end and scaling data points.
   *
   ...
   *
   * <p>This method converts numeric values into appropriately formatted strings for display as
   * axis labels. The formatting should be consistent across the axis and appropriate for the value
   * range and precision.
   *
   ...
   *
   * <p>Tick marks provide visual reference points along the axis and typically correspond to
   * labeled values. The returned list contains the raw data values where tick marks should be
   * placed, which can then be scaled using {@link #getScaledValue(double)} for positioning.
   *
