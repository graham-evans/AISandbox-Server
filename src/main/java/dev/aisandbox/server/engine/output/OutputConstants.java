...
public class OutputConstants {
    ...
    private static final List<String> FONT_LIST = List.of("/fonts/Arimo-VariableFont_wght.ttf", "/fonts/Hack-Regular.ttf");
    ...
    static {
        ...
        try {
            for (String path : FONT_LIST) {
                ...
                Font font = Font.createFont(Font.TRUETYPE_FONT, OutputConstants.class.getResourceAsStream(path));
