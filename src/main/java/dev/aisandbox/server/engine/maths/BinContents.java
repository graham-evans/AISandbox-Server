 ...
 * <p>
 * This record encapsulates all the information about a bin used in data distribution
 * analysis, including its boundaries, the number of data points it contains, and
 * its calculated density. It is typically used in conjunction with {@link StatisticsUtils}
 * for creating histograms and analyzing data distributions.
 * </p>
 * <p>
 * Example usage:
 * </p>
