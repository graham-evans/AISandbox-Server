 ...
 * <p>
 * This custom appender bridges the gap between the standard Java logging framework (Logback)
 ...
 * </p>
 * <p>
 * The appender formats each log event's message and appends it to the configured TextArea,
 * followed by a system-appropriate line separator. This provides a live log view that updates
 * as the application runs.
 * </p>
 * <p>
 * Usage in logback.xml configuration:
 * </p>
 * <pre>{@code
 ...
 * }</pre>
 * <p>
 * Note: The TextArea reference must be set programmatically after creating the appender,
 * as JavaFX components cannot be instantiated through XML configuration.
 * </p>
 *
 * @see AppenderBase
 * @see ILoggingEvent
...
public class FXLogbackAppender extends AppenderBase<ILoggingEvent> {
   ...
   * <p>
   * This method is called by the Logback framework whenever a log event needs to be processed.
   * It extracts the formatted message from the log event and adds it to the TextArea,
   * followed by a platform-specific line separator.
   * </p>
   * <p>
   * The method runs on the JavaFX Application Thread to ensure thread-safe UI updates.
   * </p>
   *
