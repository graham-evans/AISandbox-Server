 ...
 * allowing users to select from common difficulty levels. Each configuration specifies
 * a board width, height, and the number of mines to be placed.
 * </p>
 */
@Getter
...
public enum MineSize {
    /**
     * Small board configuration: 9x9 grid with 10 mines.
     * This is suitable for beginners or quick games.
     */
    SMALL("Small (8x6 10 Mines)", 9, 9, 10),
    
    /**
     * Medium board configuration: 16x16 grid with 40 mines.
     * This is the standard difficulty level for intermediate players.
     */
    MEDIUM("Medium (16x16 40 Mines)", 16, 16, 40),
    
    /**
     * Large board configuration: 24x24 grid with 99 mines.
     * This offers a challenging experience for advanced players.
     */
    LARGE("Large (24x24 99 Mines)", 24, 24, 99),
    
    /**
     * Mega board configuration: 40x40 grid with 150 mines.
     * This is an extra large board for extended gameplay sessions.
     */
