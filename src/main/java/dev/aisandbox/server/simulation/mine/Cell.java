 ...
 * and have a count of neighboring mines. This class models the state and behavior
 * of individual cells in the Mine Hunter simulation.
 * </p>
 * <p>
 * The cell's state determines how it is displayed to the player and how it
 * affects gameplay when interacted with.
 * </p>
 */
@Data
public class Cell {
   ...
   * <p>
   * Default value is true (covered). When false, the cell has been revealed
   * to the player, showing either a mine or the number of neighboring mines.
   * </p>
   */
   ...
   * <p>
   * Flagged cells cannot be uncovered until the flag is removed.
   * Correctly flagging all mines is one way to win the game.
   * </p>
   */
   ...
   * <p>
   * This value ranges from 0 to 8, representing the count of mines in
   * the eight surrounding cells (horizontally, vertically, and diagonally).
   * </p>
   */
   ...
   * <p>
   * This method provides a character-based visualization of the cell's state,
   * which is used for both communication with the agent and internal logic.
   * </p>
   * 
   ...
   * <p>
   * This method maps the cell's logical state to a visual representation
   * by providing an index into a sprite sheet of cell images.
   * </p>
   * <p>
