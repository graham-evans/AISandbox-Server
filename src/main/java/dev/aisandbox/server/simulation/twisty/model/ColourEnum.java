...
public enum ColourEnum {
  WHITE("FFFFFF", 'W'), ORANGE("FFA600", 'O'), GREEN("068E00", 'G'), RED("8E0000", 'R'), BLUE(
      "02008E", 'B'), YELLOW("F7FF00", 'Y'), OLIVE("9FD82C", 'L'), PINK("D12CD8", 'P'), CYAN(
      "2CD1D8", 'C'), GREY("B8B8B8", 'E'), IVORY("D2D399", 'I');
