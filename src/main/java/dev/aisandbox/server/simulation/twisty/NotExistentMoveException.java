...
/**
 * Exception thrown when an attempt is made to execute a move that doesn't exist for a twisty
 * puzzle.
 *
 * <p>This exception is used in twisty puzzle simulations (such as Rubik's Cube or similar puzzles)
 * when a client requests an invalid or non-existent move operation. For example, attempting to
 * perform a move that is not defined for the current puzzle configuration.
 * </p>
 *
 * @author gde
 * @version $Id: $Id
...
public class NotExistentMoveException extends SimulationException {
   ...
   *
   * <p>This constructor should be used when only an error message is needed without specifying an
   * underlying cause.
   * </p>
   *
   ...
   *
   * @param message a {@link java.lang.String} containing the description of the error
   * @param cause   a {@link java.lang.Throwable} object representing the underlying cause of this
   *                exception
   */
