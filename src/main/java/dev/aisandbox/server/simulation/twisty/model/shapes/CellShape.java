...
/**
 * Interface defining the behavior of shapes used in the twisty simulation. Implementations of this
 * interface represent different geometric shapes that can be used for cells in the simulation
 * grid.
 */
