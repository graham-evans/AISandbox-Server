...
/**
 * Implementation of {@link CellShape} representing a unit square. This class creates a square shape
 * centered at a given location with the specified scale. The square is implemented as a polygon
 * with four vertices, ignoring rotation.
 */
public class Square implements CellShape {
   ...
   * @param scale     The scaling factor determining the size of the square (distance from center to
   *                  edge = scale)
