 ...
 *
 * <p>This enum is used throughout the maze simulation to represent movement directions, path
 * connections, and agent orientations. It provides utility methods for direction conversion and
 * manipulation.
 *
 * <p>The directions follow standard compass conventions:
 * <ul>
...
public enum Direction {
   ...
   *
   * <p>This method is useful for maze generation algorithms and pathfinding logic where you need
   * to determine the reverse direction. The mappings are:
   * <ul>
   *   <li>NORTH ↔ SOUTH</li>
   *   <li>EAST ↔ WEST</li>
   * </ul>
   *
   * <p>This method is commonly used when creating bidirectional paths in mazes or when an agent
   * needs to backtrack.
   *
