 ...
 * This is implemented as a Java record for immutability and automatic implementations
...
public record Card(CardValue cardValue, CardSuite cardSuite) {
  ...
  /**
   * Returns a short description of this card.
   ...
   * Includes properties like short/long names and numeric values.
   * Supports both low and high ace values for different game rules.
   */
  @Getter
   ...
   * Each suit has a character representation.
   */
  @Getter
  @AllArgsConstructor(access = AccessLevel.PRIVATE)
